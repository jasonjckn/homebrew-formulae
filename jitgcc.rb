...
class Jitgcc < Formula
  ...
  def install
    ...
    mkdir "build" do
      ...
      unless OS.mac?
        ...
        bin.install_symlink "cpp-#{version_suffix}" => "jitcpp"
        bin.install_symlink "gcc-#{version_suffix}" => "jitgcc"
        bin.install_symlink "g++-#{version_suffix}" => "jitg++"
      end
    end
  ...
  def post_install
    unless OS.mac?
      ...
      homebrew_bin.install_symlink "jitgcc" => "jitcc" unless (homebrew_bin/"jitcc").exist?
      homebrew_bin.install_symlink "jitg++" => "jitc++" unless (homebrew_bin/"jitc++").exist?
      ...
      crtdir = if glibc_installed
        ...
        Pathname.new(Utils.popen_read("/usr/bin/jitcc", "-print-file-name=crti.o")).parent
      end
  ...
  test do
    ...
    EOS
    system "#{bin}/jitg++-#{version_suffix}", "-o", "hello-cc", "hello-cc.cc"
    assert_equal "Hello, world!\n", `./hello-cc`
